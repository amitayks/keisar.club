...
const styles = {
  ...
  mobile:
    "text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 px-20 py-4 rounded-lg font-medium transition-colors block flex justify-center",
};
