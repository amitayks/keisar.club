  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFiles) {
      ...
      const invalidFiles = filesArray.filter(
        (file) => !file.type.match("image.*") && file.type !== "application/pdf"
      );
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setFormStatus({
        ...
        success: true,
        message:
          "Your order has been submitted successfully! We will contact you shortly to confirm the details.",
      });
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          <div className='text-center'>
            ...
            <p className='text-xl text-indigo-100 max-w-3xl mx-auto'>
              Complete the form below to place your order. We'll get back to you
